/* .\parcur\fppara.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int fppara_(integer *iopt, integer *idim, integer *m, real *
	u, integer *mx, real *x, real *w, real *ub, real *ue, integer *k, 
	real *s, integer *nest, real *tol, integer *maxit, integer *k1, 
	integer *k2, integer *n, real *t, integer *nc, real *c__, real *fp, 
	real *fpint, real *z__, real *a, real *b, real *g, real *q, integer *
	nrdata, integer *ier)
{
    ...
    static real ui, rn, wi, xi[10], fp0;
